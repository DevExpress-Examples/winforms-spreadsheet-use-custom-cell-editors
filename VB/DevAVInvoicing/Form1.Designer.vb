...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.spreadsheetControl1.EmptyDocumentCreated += new System.EventHandler(this.spreadsheetControl1_EmptyDocumentCreated);
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.spreadsheetControl1.CellValueChanged += new DevExpress.XtraSpreadsheet.CellValueChangedEventHandler(this.spreadsheetControl1_CellValueChanged);
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.spreadsheetControl1.ProtectionWarning += new System.ComponentModel.HandledEventHandler(this.spreadsheetControl1_ProtectionWarning);
			...
			Me.spreadsheetCommandBarSubItem32.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {
				New DevExpress.XtraBars.LinkPersistInfo(Me.spreadsheetCommandBarButtonItem164),
			...
			Me.spreadsheetCommandBarSubItem35.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {
				...
				New DevExpress.XtraBars.LinkPersistInfo(Me.spreadsheetCommandBarButtonItem176)
			})
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btnAddRecord.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.btnAddRecord_ItemClick);
			' 
			' btnRemoveRecord
			' 
			Me.btnRemoveRecord.Caption = "Remove"
			Me.btnRemoveRecord.Glyph = (CType(resources.GetObject("btnRemoveRecord.Glyph"), System.Drawing.Image))
			Me.btnRemoveRecord.Hint = "Remove selected invoice position"
			Me.btnRemoveRecord.Id = 344
			Me.btnRemoveRecord.LargeGlyph = (CType(resources.GetObject("btnRemoveRecord.LargeGlyph"), System.Drawing.Image))
			Me.btnRemoveRecord.Name = "btnRemoveRecord"
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btnRemoveRecord.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.btnRemoveRecord_ItemClick);
			' 
			' fileRibbonPage1
			' 
